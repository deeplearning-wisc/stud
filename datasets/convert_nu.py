...
nus_categories = ('car', 'truck', 'trailer', 'bus', 'construction_vehicle',
                  ...
                  'barrier', 'animal', 'debris', 'pushable_pullable','mobility','stroller','wheelchair')
...
NAME_MAPPING = {
    ...
    'animal': 'animal',
"human.pedestrian.personal_mobility":'mobility'
}
...
def parse_args():
    ...
    parser.add_argument(
        '--data-root',
        type=str,
        default='/nobackup-slow/dataset/my_xfdu/video/nuscene',
