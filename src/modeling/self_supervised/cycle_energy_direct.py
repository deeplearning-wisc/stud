...
class CycleEnergyDirectHead(nn.Module):
    def __init__(self, cfg, cin):
        super(CycleEnergyDirectHead, self).__init__()
...
def build_cycle_energy_direct_head(cfg, input_shape):
    in_channels = cfg.MODEL.FPN.OUT_CHANNELS
    rot_head = CycleEnergyDirectHead(cfg, in_channels)
    return rot_head
