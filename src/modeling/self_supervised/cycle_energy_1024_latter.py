...
class CycleEnergy1024LatterHead(nn.Module):
    def __init__(self, cfg, cin):
        super(CycleEnergy1024LatterHead, self).__init__()
        ...
        self.map_back = nn.Linear(256, 1024)
...
def build_cycle_energy_1024_latter_head(cfg, input_shape):
    in_channels = cfg.MODEL.FPN.OUT_CHANNELS
    rot_head = CycleEnergy1024LatterHead(cfg, in_channels)
    return rot_head
